...
strings = {
    ...
    'init.epilog': 'This command is safe when run in a previously initialized'
                   ...
                   'use the -i option.',
    'menvinit.info': 'Initializes your directory with the EB CLI. Creates the application.',
    'menvinit.epilog': 'This command is safe when run in a previously initialized'
                   ' directory. To re-initialize with different options, '
                   'use the -i option.',
...
flag_text = {
    ...
    # MenvInit
    'menvinit.name': 'application name',
    'menvinit.platform': 'default Platform',
    'menvinit.keyname': 'default EC2 key name',
    'menvinit.interactive': 'force interactive mode',

    'menvinit.keyname2': 'default EC2 key name',
    'menvinit.region1': 'region1',
    'menvinit.region2': 'region2',
